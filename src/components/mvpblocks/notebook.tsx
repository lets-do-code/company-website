...
export default function NotebookHero() {
  ...
  return (
    <div className="mt-8 py-6 sm:py-14">
      ...
      <main className="relative container mt-4 max-w-[1400px]  mx-auto px-2 py-4 lg:py-8">
        <div className="relative sm:overflow-hidden h-full">
          <div className="border-primary/20 bg-background/70 shadow-primary/10 pb-10 relative grid lg:grid-cols-2 gap-5 max-md:flex-col items-start justify-start rounded-xl border px-4 pt-12 shadow-xl backdrop-blur-md max-md:text-center md:px-12 md:pb-12">
            <div>
              ...
              />
              <h1 className="mb-4 flex flex-wrap text-start gap-2 text-3xl leading-tight font-medium md:text-5xl">
                Transforming Hospitality & Business Brands Into  Stunning Digital Experiences
              </h1>
              <p className="text-muted-foreground mb-8 text-left md:max-w-[80%] md:text-xl">
                ...
                minimal effort. */}
                We help businesses stand out with high-converting, beautifully designed websites. Whether you're running a luxury resort or a growing startup, we craft
              ...
              <div className="mb-6 flex flex-wrap gap-4 md:flex-row">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>CRM & Lead Capture Systems</span>
                </div>
              </div>
              ...
              <div className="z-50 mt-2  absolute max-md:left-0 w-full inline-flex items-center justify-center lg:justify-start gap-3">
                ...
                >
                  Service{' '}<ArrowRight className="size-4 rotate-45" />
                  {/* <svg
            ...
            <div className="relative max-sm:mt-14 z-10 w-full">
              <img
                src={Banner}
                alt="MVPBlocks component library preview"
                width={1000}
                height={700}
                className="animate-in fade-in slide-in-from-bottom-12 z-10 mx-auto w-full rounded-lg border-6 border-neutral-100 object-cover shadow-2xl duration-1000 select-none dark:border-neutral-600"
              />
