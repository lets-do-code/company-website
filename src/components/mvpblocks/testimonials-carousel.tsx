...
export default function TestimonialsCarousel({
  ...
  return (
    <section
      className={cn('relative overflow-hidden max-md:px-2 py-16', className)}
    >
      ...
      <div className="container mx-auto max-w-[1400px] px-2 md:px-2">
        <motion.div
        ...
        >
          {/* from-foreground to-foreground/40 mb-4 bg-gradient-to-b bg-clip-text text-transparent*/}
          ...
          <div className="flex">
            {allTestimonials.map((testimonial, index) => (
              <div
                ...
                className="flex justify-center px-2 py-20"
              >
                <motion.div
