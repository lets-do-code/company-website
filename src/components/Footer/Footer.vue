      ...
      <div  class="flex flex-col justify-center items-start max-w-[1240px] mx-auto px-5 py-10 w-full lg:py-24">
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 w-full gap-x-5 gap-y-5">
            <section class="flex flex-col gap-3 items-start ">
              ...
              <p class="font-bold">
              Kyra  
              <!-- <span class="font-bold">IT Solutions</span> -->

              </p>
              </div>
              <p class="text-base md:text-md ">We are the leading tech <span class="text-[#F53838]/100 text-2xl font-bold">#1</span> agency in India.</p>
              <p class="text-base md:text-md  ">
                Delivering innovative solutions for businesses worldwide.<br>
            ...
            <nav class="flex flex-col ">
              <div class="flex flex-col grow items-start text-sm ">
                ...
                <ul class="flex flex-col gap-2 mt-4 text-base lg:text-md">
                  <li><a href="#" data-layername="about" >About</a></li>
                  <li><a href="#" data-layername="partners" >Partners</a></li>
                  <li><a href="#" data-layername="jobOpportunities">Services</a></li>
                  <li><a href="#" data-layername="advertise" >Contact</a></li>
